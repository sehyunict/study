...
- wrapper class `java`
	...
	__기본 자료타입을 객체로 다루기 위해서 사용하는 클래스들을 래퍼 클래스(wrapper class)__라고 한다. 
...
- 지역변수 / 전역변수
	...
	- __전역변수__는 함수 바깥에 선언하여 클래스 전체에서 사용가능한 변수이다. <br>
	  __지역변수__는 함수 속에 선언하여 해당 함수 속에서만 사용가능한 변수이다. <br>	
